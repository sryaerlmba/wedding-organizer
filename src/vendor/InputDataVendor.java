 ...
 * @author surya
 */
public class InputDataVendor extends javax.swing.JFrame {
     ...
     */
    public InputDataVendor(int id) {
        initComponents();
        this.userID = id; // Simpan ID pengguna yang diterima dari parameter konstruktor
        txtUserID.setText(String.valueOf(userID)); // Set nilai txtUserID dengan userID
    ...
    private void tampilData() {
        tabmode = crudvendor.tampilData(userID);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INPUT DATA VENDOR");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if (namaVendor.isEmpty() || namaPaket.isEmpty() || noHp.isEmpty() || harga.isEmpty() || deskripsi.isEmpty()) {
        ...
        } else if (noHp.length() > 13) { // Validasi panjang noHp tidak boleh lebih dari 13 digit
            ...
            if (crudvendor.isVendorDuplicate(namaVendor, namaPaket)) {
                JOptionPane.showMessageDialog(this, "Vendor dengan nama dan paket yang sama sudah ada!", "Peringatan", JOptionPane.WARNING_MESSAGE);
            } else {
                crudvendor.simpanData(namaVendor, namaPaket, noHp, harga, deskripsi, userID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputDataVendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputDataVendor().setVisible(true);
            }
        });
    }

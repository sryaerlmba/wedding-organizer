...
public class DataBooking extends javax.swing.JFrame {
    ...
    private void tampilData() {
        tabmode = crudBooking.loadDataBooking(userID);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA BOOKING ANDA");
        ...
        tableBooking.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Booking", "Nama Customer", "Jenis Kelamin", "Agama", "Alamat", "No HP", "id Vendor", "Nama Vendor", "Nama Paket", "Harga", "Tanggal Acara", "Deskripsi", "status"
            }
        ));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btnPembayaran, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tableBookingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableBookingMouseClicked
        ...
        if (row != -1) { // Pastikan ada baris yang dipilih
            ...
            String namaCustomer = getValueFromTable(tableBooking, row, 1);
            String jenisKelamin = getValueFromTable(tableBooking, row, 2);
            String agama = getValueFromTable(tableBooking, row, 3);
            String alamat = getValueFromTable(tableBooking, row, 4);
            String noHp = getValueFromTable(tableBooking, row, 5);
            String idVendor = getValueFromTable(tableBooking, row, 6);
            String namaVendor = getValueFromTable(tableBooking, row, 7);
            String namaPaket = getValueFromTable(tableBooking, row, 8);
            String harga = getValueFromTable(tableBooking, row, 9);
            String tanggalAcara = getValueFromTable(tableBooking, row, 10);
            String deskripsi = getValueFromTable(tableBooking, row, 11);
            String status = getValueFromTable(tableBooking, row, 12);
        ...
        if (row != -1) {
            try {
                ...
                if (status.equals("Sudah Lunas")) {
                    JOptionPane.showMessageDialog(this, "Pembayaran sudah lunas.", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                    return;
                } else if(status.equals("Cancel")) {
                    JOptionPane.showMessageDialog(this, "Anda sudah cancel silahkan booking ulang!", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }

                JOptionPane.showMessageDialog(this, "Menuju Pembayaran.");
                this.dispose();

                // Generate kode pembayaran
                String kodePembayaran = generateKodePembayaran();

                // Buat objek Pembayaran
                Pembayaran pembayaran = new Pembayaran(userID, idBooking, namaCustomer, jenisKelamin, agama, alamat, noHp, idVendor, namaVendor, namaPaket, harga, tanggalAcara, deskripsi, status, kodePembayaran);
                pembayaran.setVisible(true);

                // Tampilkan JOptionPane dengan kode pembayaran
                JOptionPane.showMessageDialog(this, "Kode pembayaran Anda: " + kodePembayaran, "Kode Pembayaran", JOptionPane.INFORMATION_MESSAGE);

            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(this, "Format data tidak valid.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih baris yang akan dibayar.", "Error", JOptionPane.ERROR_MESSAGE);
        }
        ...
        if (row != -1) {
            try {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    tableBooking.setValueAt("Cancel", row, 12);
